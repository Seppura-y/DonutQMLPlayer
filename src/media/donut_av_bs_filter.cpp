...
//namespace Donut
//{
//DonutAVBSFilter::DonutAVBSFilter()
//{
//
//}
//
...
//}
//
//AVBSFContext* DonutAVBSFilter::createBSFContext(AVCodecParameters* param)
//{
...
//}
//
//int DonutAVBSFilter::setBSFContext(AVBSFContext* ctx)
//{
...
//}
//
//int DonutAVBSFilter::sendPacket(AVPacket* pkt)
//{
//	unique_lock<mutex> lock(mtx_);
//	if (!bsf_ctx_)
//	{
...
//}
//
//int DonutAVBSFilter::recvPacket(AVPacket* pkt)
//{
//	unique_lock<mutex> lock(mtx_);
//	if (!bsf_ctx_)
//	{
