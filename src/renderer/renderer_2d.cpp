...
namespace Donut
{
	...
	void Renderer2D::drawRectangle(const glm::vec2& position, const glm::vec2& size, Ref<Texture2D>& texture, float tiling_factor, glm::vec4 tincolor)
	{
		//DN_PROFILE_FUNCTION();
	...
	void Renderer2D::drawRectangle(const glm::vec3& position, const glm::vec2& size, Ref<Texture2D>& texture, float tiling_factor, glm::vec4 tintcolor)
	{
		//DN_PROFILE_FUNCTION();
	...
	void Renderer2D::drawRotatedRectangle(const glm::vec2& position, const glm::vec2& size, float rotation, glm::vec4& color)
	{
		drawRotatedRectangle({ position.x, position.y, 1.0f }, size, rotation, color);
	}

	void Renderer2D::drawRotatedRectangle(const glm::vec3& position, const glm::vec2& size, float rotation, glm::vec4& color)
	{
		//DN_PROFILE_FUNCTION();
	...
	void Renderer2D::drawRotatedRectangle(const glm::vec2& position, const glm::vec2& size, float rotation, Ref<Texture2D>& texture, float tiling_factor, glm::vec4 tincolor)
	{
		drawRotatedRectangle({ position.x, position.y, 1.0f }, size, rotation, texture,tiling_factor, tincolor);
	}

	void Renderer2D::drawRotatedRectangle(const glm::vec3& position, const glm::vec2& size, float rotation, Ref<Texture2D>& texture, float tiling_factor, glm::vec4 tincolor)
	{
		//DN_PROFILE_FUNCTION();
